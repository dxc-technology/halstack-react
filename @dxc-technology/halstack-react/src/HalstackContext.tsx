...
import { componentTokens, defaultTranslatedComponentLabels } from "./common/variables";
import TranslatedLabelsContextTypes from "./translatedLabelsType.jsx";

const HalstackContext = React.createContext<object | null>(null);
const HalstackLanguageContext = React.createContext<TranslatedLabelsContextTypes | null>(null);
