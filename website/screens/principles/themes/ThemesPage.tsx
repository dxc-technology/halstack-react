    ...
    subSections: [
      {
        ...
        content: (
          <>
            <DxcParagraph>
              This theming strategy lets you change some decisions of the design
              system, but is still opinionated about the ones we consider
              fundamental. The list of configurable properties is small, but it
            ...
            <DxcParagraph>
              ...
              the theme inputs of the component. As you can see as follows:
            </DxcParagraph>
          </>
        ),
        subSections: [
          {
            ...
            content: (
              <>
                <DxcParagraph>
                  Tokens in the second column, which names are in bold, will
                  have the value that results from applying the transformation
                  indicated in brackets to the &#39;Theme input&#39;. (If
                  nothing, they will have the same value as the &#39;Theme
                  input&#39;).
                </DxcParagraph>
                <DxcParagraph>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          ...
                          <br />
                          <br />
                          <Code>selectedHoverBackgroundColor</Code> (-8% of
                          lightness)
                          <br />
                          <br />
                          <Code>selectedActiveBackgroundColor</Code> (-18% of
                          lightness)
                          <br />
                          <br />
      ...
      },
      {
        ...
        content: (
          <>
            <DxcParagraph>
              This theming strategy lets you change most of the design decisions
              of the design system (all the design tokens), trying to be as
              little opinionated as possible. Have in mind that it is impossible
              to make the components 100% configurable without writing actual
              code, since some design decisions are structural to the component.
              The list of configurable properties is large, and it applies at
              the component level.
            </DxcParagraph>
            <DxcAlert type="info" size="fillParent">
              We strongly recommend using the{" "}
            ...
            <DxcParagraph>
              More examples can be found in the{" "}
              <Link
                href="/utilities/halstackProvider/#advanced-theme"
                passHref
                legacyBehavior
              >
                <DxcLink>Halstack Provider section</DxcLink>
