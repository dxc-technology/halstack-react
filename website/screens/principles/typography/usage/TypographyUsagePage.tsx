...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <DxcParagraph>
          When defining the different typographic variants included in the
          Halstack Design System, we use a system of layers:
        </DxcParagraph>
        <DxcParagraph>
        ...
        <DxcBulletedList>
          <DxcBulletedList.Item>
            <Code>DxcParagraph</Code> component is intended to display text in
            paragraph format, separating it from the other components by a line
            break.
          </DxcBulletedList.Item>
          <DxcBulletedList.Item>
            <Code>DxcBulletedList</Code> component is intended to display an
            enumeration of certain elements. It is not a substitute for native
            HTML tags &lt;ul&gt; and &lt;ol&gt;.
          </DxcBulletedList.Item>
          <DxcBulletedList.Item>
            <Code>DxcHeading</Code> component is intended to define the
            hierarchy of content within the application.
          </DxcBulletedList.Item>
        </DxcBulletedList>
      </>
    ),
