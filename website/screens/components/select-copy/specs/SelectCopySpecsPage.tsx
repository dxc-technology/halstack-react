...
const SelectSpecsPage = () => {
  return (
    <DxcStack gutter="xxxlarge">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-style-guide/blob/master/website/screens/components/select-copy/specs/SelectCopySpecsPage.tsx" />
    </DxcStack>
  );
};
