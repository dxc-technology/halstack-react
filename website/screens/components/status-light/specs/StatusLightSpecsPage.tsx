...
import statesImage from "./images/status-light_states_container.png";
import prefixSuffixStatesImage from "./images/status-light_states_action.png";
import anatomyImage from "./images/status-light_anatomy.png";
