        ...
        content: (
          <>
            <DxcText as="p">
              ...
              interaction. States: <strong>enabled</strong>,{" "}
              <strong>hover</strong>, <strong>focus</strong> and{" "}
            ...
            subSections: [
              {
                ...
                content: (
                  <DxcText as="p">
                    Accordions are often not well suited for printing documents
                    and require people to print snippets of content at a time.
                  </DxcText>
                ),
              },
            ],
