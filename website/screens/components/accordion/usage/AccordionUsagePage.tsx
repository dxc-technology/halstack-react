        ...
        subSections: [
          {
            ...
            content: (
              <>
                <DxcText as="p">
                  Accordions can be placed with main page content or placed
                  inside of a container such as a side panel or tile.
                </DxcText>
            ...
            content: (
              <>
                <DxcText as="p">
                  ...
                  header. This allows for the title on the start side to align
                  with other type elements in the layout.
                </DxcText>
                <Image
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <DxcText as="p">
              The accordion component has two main states: collapsed and
              expanded. The chevron icon at the end of the accordion indicates
              which state the accordion is in. Accordions begin by default in
              the collapsed state with all content panels closed. Starting in a
              collapsed state gives the user a high level overview of the
              available information.
            </DxcText>
            <DxcList>
              <DxcText>
                Trigger collapsed and expanded states when clicking on either
                the header or icon.
              </DxcText>
              <DxcText>
              ...
              <DxcStack gutter="xsmall">
                ...
                <DxcList type="circle">
                  ...
                  <DxcText>
                    When the panel collapses, the chevron icon rotates 180
                    degrees clockwise.
                  </DxcText>
                </DxcList>
              </DxcStack>
        ...
        content: (
          <>
            <DxcText as="p">
              ...
              tables, and every custom feature that can be supported inside the
              element container.
            </DxcText>
            <Image
              src={accordionContent}
              alt="Nesting and icon usage examples"
            />
            <DxcText as="p">
              <em>
        ...
        content: (
          <>
            ...
            <DxcList>
              ...
              <DxcText>
                Only add a helper text when there is plenty space in the
              ...
              <DxcText>
                ...
                accordion title. Title display has priority when space is
                limited.
              </DxcText>
            </DxcList>
