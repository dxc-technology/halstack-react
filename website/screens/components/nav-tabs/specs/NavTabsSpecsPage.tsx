    ...
    content: (
      <>
        <DxcParagraph>
          ...
          are: <strong>enabled</strong>, <strong>hover</strong>,{" "}
...
const NavTabsSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/website/screens/components/nav-tabs/specs/NavTabsSpecsPage.tsx" />
    </DxcFlex>
  );
};
