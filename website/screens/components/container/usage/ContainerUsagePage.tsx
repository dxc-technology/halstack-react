  ...
  },
  {
    ...
    content: (
      <>
        ...
        <DxcParagraph>
          Below, we share a series of links that we consider essential to
          understand and use the Container component correctly. If you are not
          acquainted with these concepts, we strongly recommend taking a moment
          to review them:
        </DxcParagraph>
        <DxcBulletedList>
          <DxcBulletedList.Item>
