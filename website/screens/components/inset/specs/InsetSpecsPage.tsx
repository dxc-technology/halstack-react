...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <DxcParagraph>
          Positive space varies depending on the REM values and the approach to
          implementation.
        </DxcParagraph>
      </>
    ),
...
const InsetSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/website/screens/components/inset/specs/InsetSpecsPage.tsx" />
    </DxcFlex>
  );
};
