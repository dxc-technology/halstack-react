...
const sections = [
  {
    ...
    content: (
      <DxcList>
        <DxcText>Provide visual cue to suggest clickability for all types of links.</DxcText>
        <DxcText>Distinguish the visited and unvisited for navigation links.</DxcText>
  ...
  },
  {
    ...
    content: (
      <>
        <DxcText as="p">
          An icon can be used either in the normal or underlined mode to represent more graphical
          the purpose of the link, placing the icon before or after the link that is representing.
        </DxcText>
