        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <ul>
                ...
                <li>
                  <b>error</b>: Error of the file. If it is defined, it will be
                  shown and the file item will be mark as invalid.
                </li>
                <li>
          ...
          <tr>
            ...
            <td>
              ...
              If not, an icon referring to the file type will be shown.
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              ...
              That is, when the file input's inner value is modified. The list
              of files will be sent as a parameter. In this function, the files
              can be updated or returned as they come. These files must be
