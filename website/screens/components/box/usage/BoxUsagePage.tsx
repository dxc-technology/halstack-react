    ...
    subSections: [
      {
        ...
        content: (
          <>
            ...
            <DxcText as="p">
              The <Code>shadow-default</Code> and <Code>shadow-high</Code>{" "}
              variants can be used to create clear distictions between sections
              of content without the use of borders or separators, the{" "}
              <Code>no-shadow</Code> helps in the process of building the
              layout. Note that when using an application
              <Code>background-color</Code> different than white, the limits of
              the box are goig to be clearly visible no matter the variant
              chosen.
            </DxcText>
          </>
        ),
