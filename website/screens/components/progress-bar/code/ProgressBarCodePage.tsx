...
const ProgressBarCodePage = () => {
  return (
    <DxcStack gutter="xxlarge">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-style-guide/blob/master/website/screens/components/progress-bar/code/ProgressBarCodePage.tsx" />
    </DxcStack>
  );
};
