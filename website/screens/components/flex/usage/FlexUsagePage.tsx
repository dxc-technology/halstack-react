...
const sections = [
  {
    ...
    content: (
      <>
        <DxcParagraph>
          Flexboxes are comprised mainly of two axes: the main axis and the
          cross axis. The main axis is defined by the flex-direction property,
          and the cross axis runs perpendicular to it.
        </DxcParagraph>
        <DxcBulletedList>
          <DxcBulletedList.Item>
            The main axis is defined by flex-direction, which has four possible
            values: <Code>row</Code>, <Code>row-reverse</Code>,{" "}
            <Code>column</Code> and <Code>column-reverse</Code>.
          </DxcBulletedList.Item>
          <DxcBulletedList.Item>
  ...
  },
  {
    ...
    content: (
      <>
        <DxcParagraph>
          The flexbox makes no assumption about the writing mode of the
          document. Left to right or right to left can be used depending, for
          example, on the language used. A start and end edge is used to refer
          to the direction of the placement of elements.
        </DxcParagraph>
        <DxcParagraph>
          For example, If the flex-direction is row and the language is English,
          then the start edge of the main axis will be on the left, the end edge
          on the right.
        </DxcParagraph>
      </>
    ),
