    ...
    content: (
      <DxcTable>
        ...
        <tr>
          ...
          <td>
            Text representing advisory information related to the badge. Under
            the hood, this prop also serves as an accessible label for the
            component.
          </td>
          <td>-</td>
        </tr>
        <tr>
          ...
          <td>
            Affects the visual style of the badge. It can be used following
            semantic purposes or not.
          </td>
          <td>
