    ...
    content: (
      <>
        <DxcParagraph>
          ...
          little bit different compared to the version for desktop. As the size
          of the screen in those devices is reduced and once the breakpoint has
          been reached (720px), the sidenav is displayed in mobile responsive
          view.
        </DxcParagraph>
