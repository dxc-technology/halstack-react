    ...
    content: (
      <DxcTable>
        ...
        <tr>
          ...
          <td>
            Error state of the chart. If set, the component will display an
        ...
        <tr>
          ...
          <td>
            ...
            when <Code>showFilter</Code> is set to <Code>true</Code>.
          </td>
          <td>-</td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <Code>showLegend</Code> is set to <Code>true</Code>.
          </td>
          <td>-</td>
        </tr>
        <tr>
          ...
          <td>
            ...
            in the error state. A <Code>DxcButton</Code> component will be
        ...
        <tr>
          ...
          <td>
            <ExtendedTableCode>
              {`(${thresholdSeriesTypeString} | ${barDataSeriesTypeString})[]`}
            </ExtendedTableCode>
          </td>
          <td>
