      ...
      render() {
        return (
          <div>
            ...
            >
              <div>
                <DxcButton mode="basic" theme="light" label="Basic Button" onClick={this.dialogHandler1} />
                <DxcButton mode="raised" theme="light" label="Raised Button" onClick={this.dialogHandler1} />
                <DxcButton mode="flat" theme="light" label="Flat Button" onClick={this.dialogHandler1} />
                <DxcButton mode="outlined" theme="light" label="Outlined Button" onClick={this.dialogHandler1} />
              </div>
            </DxcDialog>
