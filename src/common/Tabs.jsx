  ...
  .MuiTabs-root {
    ...
    .MuiButtonBase-root {
      ...
      &:hover:not(.Mui-selected):not(.Mui-disabled) {
        opacity: ${props =>
          props.mode === "filled" ? (props.theme === "light" ? 0.8 : 1) : 1};
        background-color: ${props =>
          props.mode === "filled" ? colors.darkGrey : "transparent"};
        color: ${props =>
          props.mode === "filled" ? colors.white : colors.darkGrey};
      }
    ...
    .MuiTabs-indicator {
      background-color: ${props =>
        props.mode === "filled" ? colors.yellow : colors.black};
    }
  }
`;
