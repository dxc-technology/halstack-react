        ...
        subSections: [
          {
            ...
            content: (
              <DxcBulletedList>
                ...
                <DxcBulletedList.Item>
                  Always plot bars against a zero-value baseline. It simplifies bar length comparison and ensures
                  accurate data visualization. A non-zero baseline can distort the comparison as it disrupts the ratio
                  between bar lengths and actual values.
                </DxcBulletedList.Item>
                <DxcBulletedList.Item>
                  When constructing a bar chart, consider the order in which you will plot the bars. A common convention
                  is to sort the bars from longest to shortest. While comparisons can be made regardless of the order,
                  this approach can ease the reader's task. However, if the category labels have an inherent order, this
          ...
          },
          {
            ...
            content: (
              <DxcBulletedList>
                <DxcBulletedList.Item>
                  Avoid adding too many categories or bars in a single chart, which can make it cluttered and hard to
                  read.
                </DxcBulletedList.Item>
                <DxcBulletedList.Item>
                ...
                <DxcTable>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        In a grouped bar chart, bars representing different sub-categories are placed next to each
                        other, rather than stacked, for each main category.
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        Bars are oriented horizontally with the Y-axis representing categories and the X-axis
                        representing values.
                      </td>
                      <td>
                        Comparing quantities across different categories, especially when category names are long.
                      </td>
                    </tr>
                  </tbody>
                </DxcTable>
        ...
        subSections: [
          ...
          },
          {
            ...
            content: (
              <>
                <DxcParagraph>
                  Here is an example of how to apply our design tokens to a bar chart using the Cloudscape theming
                  strategy.
                </DxcParagraph>
                <DxcParagraph>
                  ...
                  <Link
                    href="https://cloudscape.design/foundation/visual-foundation/data-vis-colors/"
                    passHref
                    legacyBehavior
                  >
