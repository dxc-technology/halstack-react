import { DxcTable, DxcBulletedList, DxcFlex } from "@repo/ui";
...
const QuickNavSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/website/screens/components/quick-nav/specs/QuickNavSpecsPage.tsx" />
    </DxcFlex>
  );
};
