    ...
    content: (
      <DxcTable>
        ...
        <tr>
          ...
          <td>
            This function will be called when the user hovers over a data series through the chart legend. This event is
            only triggered when <Code>showLegend</Code> is set to <Code>true</Code>.
          </td>
          <td>-</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            maxValue]. Explicitly setting this is recommended. If not set, the component will auto-fit all data points.
          </td>
          <td>-</td>
        </tr>
        <tr>
