...
const sections = [
    ...
    content: (
      <>
        ...
        <Figure caption="Autosuggest text input design specifications">
          <Image src={autosuggestSpecs} alt="Autosuggest text input design specifications" />
        </Figure>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <DxcParagraph>
          Text input states: <strong>enabled</strong>, <strong>hover</strong>, <strong>focus</strong>,{" "}
        ...
        <DxcParagraph>
          List option states: <strong>enabled</strong>, <strong>hover</strong>, <strong>active</strong> and{" "}
    ...
    subSections: [
      {
        ...
        content: (
          <DxcBulletedList>
            ...
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink href="https://www.w3.org/WAI/WCAG22/Understanding/error-identification" newWindow>
                3.3.1: Error Identification
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink href="https://www.w3.org/WAI/WCAG22/Understanding/labels-or-instructions" newWindow>
...
const TextInputSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/text-input/specs/TextInputSpecsPage.tsx" />
    </DxcFlex>
  );
};
