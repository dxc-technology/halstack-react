...
const sections = [
    ...
    content: (
      <>
        <Figure caption="Password input design specifications">
          <Image src={passwordInputSpecs} alt="Password input design specifications" />
        </Figure>
        <DxcParagraph>
          The password input <Code>color</Code>, <Code>typography</Code>, <Code>border</Code>, <Code>spacing</Code>,{" "}
  ...
  },
  {
    ...
    content: (
      <>
        <DxcParagraph>The component password has the following states:</DxcParagraph>
        <DxcParagraph>
          States: <strong>enabled</strong>, <strong>hover</strong>, <strong>focus</strong>, <strong>error</strong> and{" "}
    ...
    content: (
      <>
        <Figure caption="Show and hide action to toggle the value visibility">
          <Image src={passwordInputActions} alt="Show and hide action to toggle the value visibility" />
        </Figure>
        <DxcParagraph>
        ...
        content: (
          <DxcBulletedList>
            <DxcBulletedList.Item>
              ...
              <DxcLink href="https://www.w3.org/WAI/WCAG22/Understanding/identify-input-purpose.html" newWindow>
                SC 1.3.5 Identify Input Purpose
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink href="https://www.w3.org/WAI/WCAG22/Understanding/error-suggestion" newWindow>
                SC 3.3.3 Error Suggestion
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink href="https://www.w3.org/WAI/WCAG22/Understanding/accessible-authentication" newWindow>
...
const PasswordInputSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/password-input/specs/PasswordInputSpecsPage.tsx" />
    </DxcFlex>
  );
};
