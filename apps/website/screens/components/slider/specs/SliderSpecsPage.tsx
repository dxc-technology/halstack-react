...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <DxcParagraph>
          The slider component has the following states: <strong>enabled</strong>, <strong>hover</strong>,{" "}
        ...
        content: (
          <DxcBulletedList>
            <DxcBulletedList.Item>
              ...
              <DxcLink newWindow href="https://www.w3.org/WAI/WCAG22/Understanding/info-and-relationships">
                SC 1.3.1 Info and Relationships
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink newWindow href="https://www.w3.org/WAI/WCAG22/Understanding/meaningful-sequence">
                SC 1.3.2 Meaningful Sequence
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink newWindow href="https://www.w3.org/WAI/WCAG22/Understanding/keyboard">
                SC 2.1.1 Keyboard
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink newWindow href="https://www.w3.org/WAI/WCAG22/Understanding/focus-order">
                SC 2.4.3 Focus Order
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink newWindow href="https://www.w3.org/WAI/WCAG22/Understanding/headings-and-labels">
                SC 2.4.6 Headings and Labels
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink newWindow href="https://www.w3.org/WAI/WCAG22/Understanding/focus-visible">
        ...
        content: (
          <DxcBulletedList>
            <DxcBulletedList.Item>
              ...
              <DxcLink newWindow href="https://www.w3.org/TR/wai-aria-practices-1.2/#slider">
                3.19 Slider
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              WAI-ARIA Authoring practices 1.2 -{" "}
              <DxcLink newWindow href="https://www.w3.org/TR/wai-aria-practices-1.2/examples/slider/slider-1.html">
                Slider example
              </DxcLink>
            </DxcBulletedList.Item>
          </DxcBulletedList>
...
const SliderSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/slider/specs/SliderSpecsPage.tsx" />
    </DxcFlex>
  );
};
