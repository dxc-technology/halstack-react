...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <DxcParagraph>
          The date input <Code>color</Code>, <Code>typography</Code>, <Code>border</Code>, <Code>spacing</Code>,{" "}
    ...
    subSections: [
      ...
      },
      {
        ...
        content: (
          <>
            <DxcParagraph>
              States: <strong>default</strong>, <strong>hover</strong>, <strong>focus</strong>, <strong>active</strong>,{" "}
              <strong>selected</strong>, <strong>today</strong> and <strong>disabled</strong>.
            </DxcParagraph>
        ...
        content: (
          <>
            <DxcBulletedList>
              ...
              <DxcBulletedList.Item>
                Understanding WCAG 2.2 -{" "}
                <DxcLink href="https://www.w3.org/WAI/WCAG22/Understanding/no-keyboard-trap" newWindow>
...
const DateInputSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/date-input/specs/DateInputSpecsPage.tsx" />
    </DxcFlex>
  );
};
