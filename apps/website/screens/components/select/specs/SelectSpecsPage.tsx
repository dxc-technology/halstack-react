  ...
  },
  {
    ...
    subSections: [
        ...
        content: (
          <>
            <DxcParagraph>
              ...
              are: <strong>enabled</strong>, <strong>hover</strong>, <strong>focus</strong>, <strong>active</strong>,{" "}
      ...
      },
      {
        ...
        content: (
          <>
            <DxcParagraph>Allows the user to select more than one option from the list.</DxcParagraph>
            <Figure caption="Multiple selection states">
              <Image src={selectMultipleSpecsStates} alt="Multiple selection select states" />
            </Figure>
          </>
        ),
      },
        ...
        subSections: [
          {
            ...
            content: (
              <Figure caption="Single select states">
                <Image src={selectSingleOptionState} alt="Single select states" />
              </Figure>
            ),
          },
          {
            ...
            content: (
              <Figure caption="Multiple select states">
                <Image src={selectMultipleOptionState} alt="Multiple select states" />
              </Figure>
            ),
          },
        ],
    ...
    content: (
      <>
        ...
        <DxcBulletedList type="number">
          ...
          <DxcBulletedList.Item>Selection indicator (multiple)</DxcBulletedList.Item>
          ...
          <DxcBulletedList.Item>List option checkbox (multiple)</DxcBulletedList.Item>
          <DxcBulletedList.Item>Select value</DxcBulletedList.Item>
          <DxcBulletedList.Item>List item selected indicator</DxcBulletedList.Item>
        </DxcBulletedList>
      </>
    ),
  },
    ...
    subSections: [
      ...
      },
      {
        ...
        content: (
          <>
            <DxcParagraph>
              The select component <strong>input</strong> share the same spacing tokens as the{" "}
        ...
        content: (
          <DxcBulletedList>
            <DxcBulletedList.Item>
              ...
              <DxcLink href="https://www.w3.org/WAI/WCAG22/Understanding/on-input.html" newWindow>
                SC 3.2.2: On Input
              </DxcLink>
            </DxcBulletedList.Item>
          </DxcBulletedList>
...
const SelectSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/select/specs/SelectSpecsPage.tsx" />
    </DxcFlex>
  );
};
