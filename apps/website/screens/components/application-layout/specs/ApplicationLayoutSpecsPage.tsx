    ...
    content: (
      <>
        <Figure caption="Application layout design specifications">
          <Image src={specsImage} alt="Application layout design specifications" />
        </Figure>
        <DxcParagraph>
        ...
        <DxcBulletedList>
          ...
          <DxcBulletedList.Item>A gutter is the space between columns used to separate content.</DxcBulletedList.Item>
...
const ApplicationLayoutSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/application-layout/specs/ApplicationLayoutSpecsPage.tsx" />
    </DxcFlex>
  );
};
