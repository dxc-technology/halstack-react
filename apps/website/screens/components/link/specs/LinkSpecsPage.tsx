        ...
        content: (
          <DxcBulletedList>
            <DxcBulletedList.Item>
              ...
              <DxcLink href="https://www.w3.org/WAI/WCAG22/Understanding/link-purpose-link-only.html" newWindow>
                2.4.9: Link Purpose (Link Only)
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink href="https://www.w3.org/WAI/WCAG22/Understanding/link-purpose-in-context.html" newWindow>
        ...
        content: (
          <DxcBulletedList>
            <DxcBulletedList.Item>
              ...
              <DxcLink href="https://www.w3.org/TR/wai-aria-practices-1.2/#link" newWindow>
                3.13 Link
              </DxcLink>
            </DxcBulletedList.Item>
          </DxcBulletedList>
...
const LinkSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/link/specs/LinkSpecsPage.tsx" />
    </DxcFlex>
  );
};
