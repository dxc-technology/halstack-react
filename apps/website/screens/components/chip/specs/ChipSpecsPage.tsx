...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <DxcParagraph>
          The chip component container states are <strong>enabled</strong> and <strong>disabled</strong>:
        </DxcParagraph>
        <Figure caption="Chip states">
          <Image src={statesImage} alt="Chip states" />
        </Figure>
        <DxcParagraph>
          The chip action item has the following states: <strong>enabled</strong>, <strong>hover</strong>,{" "}
          <strong>focus</strong>, <strong>active</strong> and <strong>disabled</strong>:
        </DxcParagraph>
        <Figure caption="Chip prefix and suffix states">
          <Image src={prefixSuffixStatesImage} alt="Chip prefix and suffix states" />
        </Figure>
      </>
    ),
  },
...
const ChipSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/chip/specs/ChipSpecsPage.tsx" />
    </DxcFlex>
  );
};
