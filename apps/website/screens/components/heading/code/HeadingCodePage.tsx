        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              HTML tag of the heading will be the one specified in the <Code>as</Code> prop. If no <Code>as</Code> prop
              is provided, the tag of the heading is the the one corresponding to the value of the <Code>level</Code>{" "}
