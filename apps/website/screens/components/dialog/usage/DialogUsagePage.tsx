    ...
    content: (
      <>
        <Figure caption="Example of a dialog using Halstack components as content">
          <Image src={dialogContent} alt="Example of a dialog using Halstack components as content" />
        </Figure>
        <DxcParagraph>
        ...
        <DxcBulletedList>
          <DxcBulletedList.Item>Do not use to display complex or large amounts of data.</DxcBulletedList.Item>
          <DxcBulletedList.Item>Do not recreate a full app or page in a dialog.</DxcBulletedList.Item>
          <DxcBulletedList.Item>Try always to avoid scrolling.</DxcBulletedList.Item>
        </DxcBulletedList>
      </>
    ),
  },
...
const DialogUsagePage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/dialog/usage/DialogUsagePage.tsx" />
    </DxcFlex>
  );
};
