...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <DxcParagraph>
          Different states are defined in the life cycle of the component: <strong>unselected enabled</strong>,{" "}
          <strong>unselected hover</strong>, <strong>unselected focus</strong>, <strong>unselected active</strong>,{" "}
          <strong>unselected disabled</strong>, <strong>selected enabled</strong>, <strong>selected hover</strong>,{" "}
          <strong>selected focus</strong>, <strong>selected active</strong> and <strong>selected disabled</strong>
        </DxcParagraph>
...
const ToggleGroupSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/toggle-group/specs/ToggleGroupSpecsPage.tsx" />
    </DxcFlex>
  );
};
