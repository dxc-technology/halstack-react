import { DxcParagraph, DxcInset, DxcTypography } from "@dxc-technology/halstack-react";
  ...
  return (
    <DxcInset space="var(--spacing-padding-xl)">
      <DxcParagraph>
        ...
        sollicitudin ipsum, et varius massa condimentum eget. Vivamus id mauris
        et nisl mattis consequat et id lectus. Quisque mollis lacinia nisl.
...
const scope = { DxcParagraph, DxcInset, DxcTypography };
