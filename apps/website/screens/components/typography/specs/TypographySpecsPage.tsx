...
const sections = [
  {
    ...
    content: (
      <>
        <DxcParagraph>
          For our sans-serif <Code>font-family</Code>, we use the humanist typeface Open Sans, designed by Steve
          Matteson and licensed under the{" "}
          <DxcLink href="https://www.apache.org/licenses/LICENSE-2.0.html" newWindow>
    ...
    content: (
      <>
        <DxcParagraph>
          ...
          balanced <Code>font-weight</Code> values.
        </DxcParagraph>
        <DxcTable>
          <thead>
            <tr>
    ...
    subSections: [
      ...
      },
      {
        ...
        content: (
          <>
            <DxcParagraph>
              We calibrate our <Code>letter-spacing</Code> at large scales to provide a better legibility and
      ...
      },
      {
        ...
        content: (
          <>
            <DxcParagraph>
              We use a ratio of 1:1.5 as a standard <Code>line-height</Code> value. A body font of 16px (1rem) returns a
            ...
            <DxcTable>
              ...
              <tbody>
                <tr>
                  ...
                  <td>Whitespace is preserved by the browser. Text will only wrap on line breaks.</td>
                  <td>
        ...
        content: (
          <DxcBulletedList>
            <DxcBulletedList.Item>
              ...
              <DxcLink href="https://www.w3.org/WAI/WCAG21/Understanding/contrast-enhanced.html" newWindow>
                SC 1.4.6: Contrast (Enhanced)
              </DxcLink>
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>
              Understanding WCAG 2.2 -{" "}
              <DxcLink href="https://www.w3.org/WAI/WCAG22/Understanding/text-spacing" newWindow>
...
const TypographySpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/typography/specs/TypographySpecsPage.tsx" />
    </DxcFlex>
  );
};
