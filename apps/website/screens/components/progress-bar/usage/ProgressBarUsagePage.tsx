...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <DxcParagraph>
          The component progress-bar has two variants: <strong>default</strong> and <strong>overlay</strong>.
        </DxcParagraph>
...
const ProgressBarUsagePage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/progress-bar/usage/ProgressBarUsagePage.tsx" />
    </DxcFlex>
  );
};
