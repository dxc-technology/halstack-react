...
const sections = [
  {
    ...
    content: (
      <Figure caption="48px height fixed tabs design specifications">
        <Image src={specsImage} alt="48px height fixed tabs design specifications" />
      </Figure>
    ),
  },
  {
    ...
    content: (
      <>
        <Figure caption="48px height fixed tabs design specifications">
          <Image src={specsFixed} alt="48px height fixed tabs design specifications" />
        </Figure>
        <Figure caption="72px height fixed tabs design specifications">
          <Image src={specsFixed72} alt="72px height fixed tabs design specifications" />
        </Figure>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        <DxcParagraph>
          Tabs can get different states based on user interaction. These states are: <strong>inactive</strong>,{" "}
          <strong>enabled</strong>, <strong>hover</strong>, <strong>pressed</strong>, <strong>focus</strong> and{" "}
    ...
    content: (
      <>
        ...
        <DxcBulletedList type="number">
          ...
          <DxcBulletedList.Item>Active icon (Optional if there&#39;s a label)</DxcBulletedList.Item>
          <DxcBulletedList.Item>Active text label (Optional if there&#39;s an icon)</DxcBulletedList.Item>
          <DxcBulletedList.Item>Active tab indicator</DxcBulletedList.Item>
          <DxcBulletedList.Item>Inactive icon (Optional if there&#39;s a label)</DxcBulletedList.Item>
          <DxcBulletedList.Item>Inactive text label (Optional if there&#39;s an icon)</DxcBulletedList.Item>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <DxcParagraph>
          <DxcLink href="https://www.w3.org/TR/wai-aria-practices-1.1/#tabpanel" newWindow>
...
const TabsSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/tabs/specs/TabsSpecsPage.tsx" />
    </DxcFlex>
  );
};
