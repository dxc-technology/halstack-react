...
const sections = [
    ...
    subSections: [
      {
        ...
        content: (
          <DxcBulletedList>
            <DxcBulletedList.Item>Displaying and grouping additional information.</DxcBulletedList.Item>
            <DxcBulletedList.Item>
              To shorten pages and reduce scrolling when content is not crucial to read in full.
            </DxcBulletedList.Item>
            <DxcBulletedList.Item>Adding granular control over the information on a given page.</DxcBulletedList.Item>
          </DxcBulletedList>
        ),
      },
      {
          ...
          <>
            ...
            <Figure
              caption={
                <>
                  <DxcParagraph>
                    <strong>Left</strong>. Place chevron icon at the end of the accordion header.
                  </DxcParagraph>
                  <DxcParagraph>
      ...
      <>
        ...
        <DxcBulletedList>
          ...
          <DxcFlex direction="column" gap="0.5rem">
            <DxcBulletedList.Item>Use a chevron icon to indicate the expand/collapse behavior.</DxcBulletedList.Item>
        ...
        <Figure
          caption={
            <>
              <DxcParagraph>
                <strong>Left</strong>. Trigger collapsed and expanded states when clicking on either the header or icon.
              </DxcParagraph>
              <DxcParagraph>
                <strong>Right</strong>. Leave the header without caret or use a button to trigger the expand/collapse
                action.
              </DxcParagraph>
            </>
          }
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <DxcParagraph>
          <em>When one accordion panel is expanded, the rest of the group should be collapsed.</em>
        </DxcParagraph>
      </>
    ),
  },
      ...
      <>
        ...
        <Figure
          caption={
            <>
              <DxcParagraph>
                <strong>Left</strong>. Nesting is allowed. Use in parent accordion Open Sans Semibold.
              </DxcParagraph>
              <DxcParagraph>
  ...
  },
  {
    ...
    content: (
      <>
        <DxcParagraph>Assistive text can be shown at the end of the accordion header when needed.</DxcParagraph>
        <DxcBulletedList>
          <DxcBulletedList.Item>Icons and images can not be used.</DxcBulletedList.Item>
          <DxcBulletedList.Item>
