    ...
    content: (
      <>
        <Figure caption="Divider orientation design specifications">
          <Image src={orientationSpecs} alt="Divider orientation design specifications" />
        </Figure>
...
const DividerSpecsPage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/divider/specs/DividerSpecsPage.tsx" />
    </DxcFlex>
  );
};
