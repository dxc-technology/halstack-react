...
const sections = [
  {
    ...
    content: (
      <DxcBulletedList>
        <DxcBulletedList.Item>Use dividers to separate content into distinct groups.</DxcBulletedList.Item>
        ...
        <DxcBulletedList.Item>Use dividers to create groups, not individual items.</DxcBulletedList.Item>
        <DxcBulletedList.Item>
...
const DividerUsagePage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/divider/usage/DividerUsagePage.tsx" />
    </DxcFlex>
  );
};
