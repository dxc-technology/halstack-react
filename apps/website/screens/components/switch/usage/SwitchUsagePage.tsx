...
const sections = [
  {
    ...
    content: (
      <DxcBulletedList>
        ...
        <DxcBulletedList.Item>Whenever is possible stack the switch component vertically.</DxcBulletedList.Item>
        <DxcBulletedList.Item>
...
const SwitchUsagePage = () => {
  return (
    <DxcFlex direction="column" gap="4rem">
      ...
      <DocFooter githubLink="https://github.com/dxc-technology/halstack-react/blob/master/apps/website/screens/components/switch/usage/SwitchUsagePage.tsx" />
    </DxcFlex>
  );
};
