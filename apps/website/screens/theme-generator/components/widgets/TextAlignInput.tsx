...
const textAlignOptions = ["left", "right", "center", "justify", "justify-all", "start", "end", "match-parent"];

const TextAlignInput = ({ propertyName, propertyValue, onChangeCustomTheme }: ThemeInputWidgetProps): JSX.Element => (
  <StyledSelect
    onChange={(event) => {
