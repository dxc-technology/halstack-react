...
const Footer = () => (
  <PreviewContainer>
    <Mode text="Default">
      <DxcApplicationLayout.Footer copyright="Copyright" socialLinks={social} bottomLinks={bottom}>
        <DxcInset top="1rem">
          <DxcFlex>
            <DxcLink href="https://www.linkedin.com/company/dxctechnology">Linkedin</DxcLink>
          </DxcFlex>
        </DxcInset>
