...
const Accordion = () => {
  ...
  return (
    <PreviewContainer>
      <Mode text="Default">
        <DxcAccordion label="Default Accordion" assistiveText="Assistive text">
          <DxcInset space="2rem">
      ...
      <Mode text="Icon">
        <DxcAccordion label="Default Accordion" icon={facebookIcon}>
          <DxcInset space="2rem">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit
            leo lobortis eget.
          </DxcInset>
      ...
      <Mode text="Disabled">
        <DxcAccordion disabled icon={facebookIcon} label="Default Accordion" assistiveText="Assistive text">
          <DxcInset space="2rem">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex, sit amet blandit
            leo lobortis eget.
          </DxcInset>
      ...
      <Mode text="Accordion Group">
        <DxcAccordionGroup indexActive={indexAccordion} onActiveChange={onActiveChange}>
