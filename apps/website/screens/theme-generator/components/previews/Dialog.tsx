...
import { DxcDialog, DxcButton, DxcHeading, DxcTextInput, DxcFlex, DxcParagraph, DxcInset } from "@repo/ui";
...
const Dialog = () => {
  ...
  return (
    <PreviewContainer>
      ...
      <Mode text="Modal">
        <DxcButton label="See account information" onClick={handleClickBackground} />
      ...
      <Mode text="With close button">
        ...
        {isNoOverlayDialogVisible && (
          <DxcDialog onBackgroundClick={handleClickNoOverlay} onCloseClick={handleClickNoOverlay} overlay={false}>
            <DxcInset space="1.5rem">
              <DxcParagraph>An example of Dialog without overlay (darker background).</DxcParagraph>
            </DxcInset>
          </DxcDialog>
        )}
      </Mode>
