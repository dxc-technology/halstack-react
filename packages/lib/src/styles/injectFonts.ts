import materialSymbols from "./fonts/Material-symbols-outlined.woff2";
import openSansMath from "./fonts/Open-sans-math.woff2";
...
if (typeof document !== "undefined" && !document.getElementById(FONT_FACE_ID)) {
  ...
  style.textContent = `
    ...
    @font-face {
        ...
        font-stretch: 100%;
        font-display: swap;
        src: url(${openSansMath}) format('woff2');
    ...
    @font-face {
        ...
        font-stretch: 100%;
        font-display: swap;
        src: url(${openSansSymbols}) format('woff2');
