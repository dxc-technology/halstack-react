        ...
        sections={[
          {
            ...
            section: () => (
              <Section>
                ...
                />
                <p>
                  Everything between this tags will be displayed as a header, at
                  the top of the screen. If you want to show a{" "}
                  <DxcLink
                  ...
                  DxcApplicationLayout without the tags. This is optional and if
                  it is not specified, the DxcHeader will be shown by default.
                </p>
                <DxcHeading
                ...
                />
                <p>
                  Everything between the tags will be displayed as a footer, at
                  the bottom of the screen. If you want to show a{" "}
                  <DxcLink
                  ...
                  , as a shortcut, you can use it as a direct child of the
                  DxcApplicationLayout without the tags. This is optional and if
                  it is not specified, the DxcFooter will be shown by default.
                </p>
                <DxcHeading
                ...
                <p>
                  ...
                  <DxcLink
                    ...
                    text="DxcSidenav"
                  ></DxcLink>
                  , positioned on the left side of the screen, between the
                  header and the footer. This is optional and if it is not
                  specified, the DxcSidenav will not be shown.
                </p>
                <DxcHeading
                  text="Props"
                  level={5}
                ...
                <p>
                  In addition to these props, DxcApplicationLayout will also
                  have the{" "}
                  <DxcLink
                    href={`#/components/sidenav`}
                    underlined={false}
                ...
                <DxcHeading
                  text="DxcApplicationLayout.Main"
                  level={4}
                  weight="bold"
                />
                <p>
