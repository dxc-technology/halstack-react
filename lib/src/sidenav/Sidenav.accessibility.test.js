...
import { disabledRules as rules } from "../../test/accessibility/rules/specific/sidenav/disabledRules.js";
    ...
    const { container } = render(
      <DxcSidenav title="Title">
        <DxcSidenav.Section>
          ...
          <DxcSidenav.Link href="#" icon={iconSVG} selected>
            Link
          </DxcSidenav.Link>
        </DxcSidenav.Section>
        <DxcSidenav.Section>
          <DxcSidenav.Group title="Collapsable" icon={iconSVG} collapsable>
