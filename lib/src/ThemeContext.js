...
const parseTheme = (theme) => {
  ...
  accordionTokens.fontColor = theme?.accordion?.fontColor ?? accordionTokens.fontColorBase;
  ...
  accordionTokens.headerFocusBorderColor = theme?.accordion?.accentColor ?? accordionTokens.arrowColor;
