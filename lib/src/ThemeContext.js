...
const parseTheme = (theme) => {
  ...
  buttonTokens.textHoverBackgroundColor =
    theme?.button?.textHoverBackgroundColor ?? buttonTokens.textHoverBackgroundColor;
  ...
  buttonTokens.textActiveBackgroundColor =
    subLightness(theme?.button?.textHoverBackgroundColor, 5) ?? buttonTokens.textActiveBackgroundColor;
