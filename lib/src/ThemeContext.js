...
const parseTheme = (theme) => {
  ...
  buttonTokens.primaryHoverBackgroundColor =
    theme?.button?.primaryHoverBackgroundColor ?? buttonTokens.primaryHoverBackgroundColor;
  ...
  buttonTokens.secondaryHoverBackgroundColor =
    theme?.button?.secondaryHoverBackgroundColor ?? buttonTokens.secondaryHoverBackgroundColor;
