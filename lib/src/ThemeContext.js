...
const parseTheme = (theme) => {
  ...
  fileInputTokens.labelFontColor = theme?.fileInput?.fontColor ?? footerTokens.labelFontColor;
  fileInputTokens.helperTextFontColor = theme?.fileInput?.fontColor ?? footerTokens.helperTextFontColor;
  fileInputTokens.dropLabelFontColor = theme?.fileInput?.fontColor ?? footerTokens.dropLabelFontColor;
  fileInputTokens.fileNameFontColor = theme?.fileInput?.fontColor ?? footerTokens.fileNameFontColor;
  ...
  const newInputTokens = componentTokensCopy.newInputText;
  newInputTokens.hoverListOptionBackgroundColor =
    theme?.newInputText?.baseColor ?? newInputTokens.hoverListOptionBackgroundColor;
  newInputTokens.activeListOptionBackgroundColor =
    subLightness(theme?.newInputText?.baseColor, 15) ?? newInputTokens.activeListOptionBackgroundColor;
