...
const parseTheme = (theme) => {
  ...
  accordionTokens.disabledAssistiveTextFontColor =
    setLightness(theme?.accordion?.fontColor, 35) ?? accordionTokens.disabledAssistiveTextFontColor;
  accordionTokens.disabledTitleLabelFontColor =
    setLightness(theme?.accordion?.fontColor, 35) ?? accordionTokens.disabledTitleLabelFontColor;
  accordionTokens.disabledArrowColor =
    setLightness(theme?.accordion?.accentColor, 50) ?? accordionTokens.disabledArrowColor;
  accordionTokens.disabledIconColor =
    setLightness(theme?.accordion?.accentColor, 50) ?? accordionTokens.disabledIconColor;
  ...
  headerTokens.customContentFontColor = theme?.header?.fontColor ?? headerTokens.customContentFontColor;
  headerTokens.menuCustomContentFontColor = theme?.header?.fontColor ?? headerTokens.menuCustomContentFontColor;
