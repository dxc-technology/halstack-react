...
const parseTheme = (theme) => {
  ...
  progressBarTokens.totalLine = theme?.progressBar?.totalLine ?? progressBarTokens.totalLine;
  progressBarTokens.fontColor = theme?.progressBar?.fontColor ?? progressBarTokens.fontColor;
  progressBarTokens.opaqueTotalLine = addOpacity(theme?.progressBar?.totalLine, 0.34) ?? progressBarTokens.opaqueTotalLine;
