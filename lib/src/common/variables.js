...
export const componentTokens = {
  ...
  button: {
    ...
    primaryBackgroundColorOnDark:"#575757",
    primaryHoverBackgroundColor: globalTokens.black,
    primaryHoverBackgroundColorOnDark:"#e6e6e6", 
    ...
    primaryActiveBackgroundColorOnDark:"#cccccc",
    disabledPrimaryBackgroundColor: globalTokens.lighterPurple,
    disabledPrimaryBackgroundColorOnDark:"#575757",
    disabledPrimaryFontColor: globalTokens.white,
    disabledPrimaryFontColorOnDark:"#000000",
    primaryButtonBorderThickness: "0px",
    primaryButtonBorderColor:"",
    primaryButtonBorderColorOnDark:"", 
    primaryButtonBorderStyle:"none",
    primaryButtonBorderRadius:"4px",
    primaryButtonFontFamily:globalTokens.type_sans,
    primaryButtonFontSize:globalTokens.type_scale_02,
    primaryButtonFontWeight:globalTokens.type_regular,
    secondaryOutlinedColor: globalTokens.purple,
    secondaryOutlinedColorOnDark:"#FFFFFF",
    ...
    secondaryHoverOutlinedColorOnDark:"#FFFFFF", 
    ...
    secondaryActiveBackgroundColorOnDark:"#292929", 
    secondaryHoverBackgroundColor: globalTokens.darkWhite,
    secondaryHoverBackgroundColorOnDark:"#141414", 
    disabledSecondaryOutlinedColor: globalTokens.lighterPurple,
    disabledSecondaryOutlinedColorOnDark:"#575757", 
    disabledSecondaryFontColor: globalTokens.lighterBlack,
    disabledSecondaryFontColorOnDark:"#575757", 
    secondaryButtonBorderThickness:"2px",
    secondaryButtonBorderStyle:"solid",
    secondaryButtonBorderRadius:"4px",
    secondaryButtonFontFamily:globalTokens.type_sans,
    secondaryButtonFontSize:globalTokens.type_scale_02,
    secondaryButtonFontWeight:globalTokens.type_regular,
    ...
    textHoverBackgroundColorOnDark:"#141414", 
    ...
    textActiveBackgroundColorOnDark:"#a3a3a3", 
    disabledTextFontColor: globalTokens.lighterPurple,
    disabledTextBackgroundColor: "transparent",
    disabledTextBackgroundColorOnDark:"transparent", 
    disabledTextFontColorOnDark:"#575757",
    textButtonBorderThickness:"0px",
    textButtonBorderColor:"",
    textButtonBorderColorOnDark:"",
    textButtonBorderStyle:"none",
    textButtonBorderRadius:"4px",
    textButtonFontFamily:globalTokens.type_sans,
    textButtonFontSize:globalTokens.type_scale_02,
    textButtonFontWeight:globalTokens.type_regular,
    focusColor: globalTokens.blue,
