...
export const componentLabels = {
  ...
  passwordInput: {
    ...
    inputHidePassword: "Hide password",
  },
  radioGroup: {
  ...
  numberInput: {
    valueGreaterThanErrorMessage: (value) => `Value must be greater than ${value}`,
    valueLessThanErrorMessage: (value) => `Value must be less than ${value}`,
  ...
  fileInput: {
    ...
    filedropDropzoneButtonLabelDefault: "Select",
    multipleDropLabelDefault: "or drop files",
    singleFiledropDropzoneDropLabelDefault: "or drop a file",
  },
  paginator: {
...
export const test = {
  dateInput: {
    invalidDateErrorMessage: "Invalid date",
    lala: (param1, param2) => `${param1} ${param2}`,
  },
};
