...
export const componentTokens = {
  ...
  alert: {
    ...
    alertTypeFontFamily: globalTokens.type_sans,
    alertTypeFontSize: globalTokens.type_scale_01, 
    alertTypeFontColor: globalTokens.black,
    alertTypeFontWeight: globalTokens.type_bold, 
    alertTypeTextTransform: globalTokens.type_uppercase, 
    alertTypeFontStyle: globalTokens.type_normal,
    alertTypePaddingRight: "10px",
    alertTypePaddingLeft: "0px",
    alertTypePaddingTop: "0px",
    alertTypePaddingBottom: "0px",
    alertContentFontFamily: globalTokens.type_sans,
    alertContentFontSize: globalTokens.type_scale_01, 
    alertContentFontColor: globalTokens.black,
    alertContentFontWeight: globalTokens.type_normal, 
    alertContentPaddingLeft: "46px",
    alertContentPaddingRight: "12px",
    alertContentPaddingTop: "8px",
    alertContentPaddingBottom: "20px",
    overlayOpacity: "0.8",  
    boxShadowOffsetX: "0px",
    ...
    alertHeight: "48px",  
    alertInlineTextPaddingLeft: "10px",
    alertInlineTextPaddingRight: "10px",
    alertInlineTextPaddingTop: "0px",
    alertInlineTextPaddingBottom: "0px",
    alertIconPaddingLeft: "12px",
    alertIconPaddingRight: "0px",
    alertIconPaddingTop: "0px",
    alertIconPaddingBottom: "0px",
    alertIconMaxWidth: "20px",
    alertIconMaxHeight: "20px",
    alertTextPaddingLeft: "12px",
    alertTextPaddingRight: "12px",
    alertTextPaddingTop: "0px",
    alertTextPaddingBottom: "0px",
