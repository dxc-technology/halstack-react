...
export const componentTokens = {
  ...
  slider: {
    ...
    thumbHeight: "12px",
    thumbWidth: "12px",
    thumbVerticalPosition: "12px", // 49.5%
    thumbBackgroundColor: globalTokens.hal_blue_s_35,
    thumbBackgroundColorOnDark: globalTokens.hal_blue_l_50,
    activeThumbScale: "1.3333",
    activeThumbBackgroundColor: globalTokens.hal_blue_d_20, 
    activeThumbBackgroundColorOnDark: globalTokens.hal_grey_l_60,
    dotsHeight: "4px",
    dotsWidth: "4px",
    dotsVerticalPosition: "11px", // 46%
    dotsBackgroundColor: globalTokens.hal_blue_s_35,
    dotsBackgroundColorOnDark: globalTokens.hal_blue_l_50,
    ...
    disabledThumbVerticalPosition: "10px", // 40.9%
    disabledThumbBackgroundColor: globalTokens.hal_grey_l_75,
    disabledThumbBackgroundColorOnDark: "#575757",
    disabledDotsVerticalPosition: "42%",
    disabledDotsBackgroundColor: globalTokens.hal_grey_l_75,
    disabledDotsBackgroundColorOnDark: globalTokens.hal_grey_l_60,
    disabledTrackLineColor: globalTokens.hal_blue_l_95,
