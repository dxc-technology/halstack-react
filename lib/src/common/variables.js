...
export const componentTokens = {
  accordion: {
    ...
    contentTextFontFamily: globalTokens.type_sans,
    contentTextFontSize: globalTokens.type_scale_03, 
    contentTextFontWeight: globalTokens.type_ligth, 
    contentTextFontColor: globalTokens.black, 
    ...
    assistiveTextFontColor: globalTokens.inherit,
    assistiveTextLetterSpacing: globalTokens.type_spacing_wide_01,
    assistiveTextMinWidth: "100px",
    headerTitleFontFamily: globalTokens.type_sans,
    headerTitleFontSize: globalTokens.type_scale_03, 
    headerTitleFontWeight: globalTokens.type_regular,
    headerTitleFontStyle: globalTokens.type_normal,
    headerTitleFontColor: globalTokens.black,
    headerTitleMarginRight: "48px", 
    headerTitleMarginLeft: "0px", 
    headerTitleMarginTop: "0px", 
    headerTitleMarginBottom: "0px", 
