...
export const Chromatic = () => (
  <>
    ...
    <ExampleContainer>
      <Title
        title="Chip with prefix SVG (small icon)"
        theme="light"
        level={4}
      />
    ...
    <ExampleContainer>
      <Title
        title="Chip with suffix SVG (large icon)"
        theme="light"
        level={4}
      />
    ...
    <ExampleContainer>
      <Title
        title="Chip with prefix (SVG) and suffix (URL)"
        theme="light"
        level={4}
      />
      <DxcChip
    ...
    <ExampleContainer>
      <Title
        title="Chip with ellipsis, suffix and prefix"
        theme="light"
        level={4}
      />
      <div style={{ width: "200px" }}>
