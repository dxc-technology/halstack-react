...
export const Chromatic = () => (
  <>
    ...
    <ExampleContainer>
      ...
      <DxcAlert
        type="confirm"
        inlineText="Confirm type alert with inline text."
      />
    </ExampleContainer>
    <ExampleContainer>
      ...
      <DxcAlert
        type="warning"
        inlineText="Warning type alert with inline text."
      />
    </ExampleContainer>
    <ExampleContainer>
    ...
    <ExampleContainer>
      ...
      <DxcAlert
        inlineText="Info type alert with inline text and close button."
        onClose={() => {}}
      />
    </ExampleContainer>
    ...
    <ExampleContainer>
      ...
      <DxcAlert
        margin="xxsmall"
        inlineText="Info type alert with inline text and xxsmall margin."
      />
    </ExampleContainer>
    <ExampleContainer>
      ...
      <DxcAlert
        margin="xsmall"
        inlineText="Info type alert with inline text and xsmall margin."
      />
    </ExampleContainer>
    <ExampleContainer>
      ...
      <DxcAlert
        margin="small"
        inlineText="Info type alert with inline text and small margin."
      />
    </ExampleContainer>
    <ExampleContainer>
      ...
      <DxcAlert
        margin="medium"
        inlineText="Info type alert with inline text and medium margin."
      />
    </ExampleContainer>
    <ExampleContainer>
      ...
      <DxcAlert
        margin="large"
        inlineText="Info type alert with inline text and large margin."
      />
    </ExampleContainer>
    <ExampleContainer>
      ...
      <DxcAlert
        margin="xlarge"
        inlineText="Info type alert with inline text and xlarge margin."
      />
    </ExampleContainer>
    <ExampleContainer>
      ...
      <DxcAlert
        margin="xxlarge"
        inlineText="Info type alert with inline text and xxlarge margin."
      />
    </ExampleContainer>
