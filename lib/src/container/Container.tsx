...
const Container = styled.div<StyledProps>`
  ...
  border-width: ${({ border }) =>
    border && "width" in border ? `${border?.width}` : ""};
  border-style: ${({ border }) =>
    border && "style" in border ? `${border?.style}` : ""};
  border-color: ${({ border }) =>
    border && "color" in border ? `${getCoreColorToken(border?.color)}` : ""};
  ...
  margin-top: ${({ margin }) =>
    typeof margin === "object" ? spaces[margin.top] : ""};
  margin-right: ${({ margin }) =>
    typeof margin === "object" ? spaces[margin.right] : ""};
  margin-bottom: ${({ margin }) =>
    typeof margin === "object" ? spaces[margin.bottom] : ""};
  margin-left: ${({ margin }) =>
    typeof margin === "object" ? spaces[margin.left] : ""};
  ...
  overflow-x: ${({ $overflow }) =>
    typeof $overflow === "object" ? `${$overflow?.x}` : ""};
  overflow-y: ${({ $overflow }) =>
    typeof $overflow === "object" ? `${$overflow?.y}` : ""};

  padding: ${({ padding }) =>
    typeof padding === "string" ? spaces[padding] : ""};
  padding-top: ${({ padding }) =>
    typeof padding === "object" ? spaces[padding.top] : ""};
  padding-right: ${({ padding }) =>
    typeof padding === "object" ? spaces[padding.right] : ""};
  padding-bottom: ${({ padding }) =>
    typeof padding === "object" ? spaces[padding.bottom] : ""};
  padding-left: ${({ padding }) =>
    typeof padding === "object" ? spaces[padding.left] : ""};
`;
