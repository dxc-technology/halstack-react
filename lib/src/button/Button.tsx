...
const calculateWidth = (margin: ButtonPropsType["margin"], width: ButtonPropsType["width"]) =>
  width === "fillParent"
    ? `calc(${widths[width]} - ${getMargin(margin, "left")} - ${getMargin(margin, "right")})`
    : widths[width];
...
const getButtonStyles = (
  ...
  let commonPrimaryStyles = `
    ...
    font-size: ${size === "small" ? theme.primarySmallFontSize : size === "medium" ? theme.primaryMediumFontSize : theme.primaryLargeFontSize};
  ...
  let commonSecondaryStyles = `
    ...
    font-size: ${size === "small" ? theme.secondarySmallFontSize : size === "medium" ? theme.secondaryMediumFontSize : theme.secondaryLargeFontSize};
  ...
  let commonTertiaryStyles = `
    ...
    font-size: ${size === "small" ? theme.tertiarySmallFontSize : size === "medium" ? theme.tertiaryMediumFontSize : theme.tertiaryLargeFontSize};
  ...
  switch ($mode) {
    case "primary":
      switch (semantic) {
        case "brand":
          enabled = `background-color: ${theme.primaryBrandBackgroundColor};
          color: ${theme.primaryBrandFontColor};`;
          hover = `background-color: ${theme.primaryHoverBrandBackgroundColor};`;
          active = `background-color: ${theme.primaryActiveBrandBackgroundColor};
          border-color: transparent;
          outline: none;
          box-shadow: 0 0 0 2px ${theme.focusBorderColor};`;
          disabled = `cursor: not-allowed;
          background-color: ${theme.primaryDisabledBrandBackgroundColor};
          color: ${theme.primaryDisabledBrandFontColor};`;
          break;
        case "error":
    ...
    case "secondary":
      switch (semantic) {
        case "brand":
          enabled = `background-color: ${theme.secondaryBrandBackgroundColor};
          color: ${theme.secondaryBrandFontColor};
          border-color ${theme.secondaryBrandBorderColor};`;
          hover = `background-color: ${theme.secondaryHoverBrandBackgroundColor};
          color: ${theme.secondaryHoverBrandFontColor};`;
          active = `background-color: ${theme.secondaryActiveBrandBackgroundColor};
          color: ${theme.secondaryHoverBrandFontColor};
          border-color: transparent;
          outline: none;
          box-shadow: 0 0 0 2px ${theme.focusBorderColor};`;
          ...
          disabled = `cursor: not-allowed;
          background-color: ${theme.secondaryDisabledBrandBackgroundColor};
          color: ${theme.secondaryDisabledBrandFontColor};
          border-color: ${theme.secondaryDisabledBrandBorderColor};`;
          break;
        case "error":
    ...
    case "tertiary":
      switch (semantic) {
        case "brand":
          enabled = `background-color: ${theme.tertiaryBrandBackgroundColor};
            color: ${theme.tertiaryBrandFontColor};`;
          hover = `background-color: ${theme.tertiaryHoverBrandBackgroundColor};`;
          active = `background-color: ${theme.tertiaryActiveBrandBackgroundColor};
          border-color: transparent;
          outline: none;
          box-shadow: 0 0 0 2px ${theme.focusBorderColor};`;
          disabled = `cursor: not-allowed;
          background-color: ${theme.tertiaryDisabledBrandBackgroundColor};
          color: ${theme.tertiaryDisabledBrandFontColor};`;
          break;
        case "error":
...
const Button = styled.button<{
  ...
  width: ${(props) => calculateWidth(props.margin, props.width)};
...
const IconContainer = styled.div<{
  ...
  display: flex;
  font-size: ${(props) => (props.size === "small" ? "16" : props.size === "medium" ? "16" : "24")}px;

  svg {
    height: ${(props) => (props.size === "small" ? "16" : props.size === "medium" ? "16" : "24")}px;
    width: ${(props) => (props.size === "small" ? "16" : props.size === "medium" ? "16" : "24")}px;
  }
`;
