  ...
  it("Should not have basic accessibility issues", async () => {
    const { container } = render(
      <DxcFlex>
        ...
        <DxcBadge color="blue" mode="notification" label={1000000} size="large" icon={icon} notificationLimit={99999999} title="Badge2" />
        <DxcBadge color="green" mode="contextual" label="Label" size="small" icon={icon} title="Badge1" />
        <DxcBadge color="green" mode="notification" label={1000000} size="large" icon={icon} notificationLimit={99999999} title="Badge2" />
        <DxcBadge color="grey" mode="contextual" label="Label" size="small" icon={icon} title="Badge1" />
        <DxcBadge color="grey" mode="notification" label={1000000} size="large" icon={icon} notificationLimit={99999999} title="Badge2" />
        <DxcBadge color="orange" mode="contextual" label="Label" size="small" icon={icon} title="Badge1" />
        <DxcBadge color="orange" mode="notification" label={1000000} size="large" icon={icon} notificationLimit={99999999} title="Badge2" />
        <DxcBadge color="purple" mode="contextual" label="Label" size="small" icon={icon} title="Badge1" />
        <DxcBadge color="purple" mode="notification" label={1000000} size="large" icon={icon} notificationLimit={99999999} title="Badge2" />
        <DxcBadge color="red" mode="contextual" label="Label" size="small" icon={icon} title="Badge1" />
        <DxcBadge color="red" mode="notification" label={1000000} size="large" icon={icon} notificationLimit={99999999} title="Badge2" />
        <DxcBadge color="yellow" mode="contextual" label="Label" size="small" icon={icon} title="Badge1" />
        <DxcBadge color="yellow" mode="notification" label={1000000} size="large" icon={icon} notificationLimit={99999999} title="Badge2" />
      </DxcFlex>
    );
