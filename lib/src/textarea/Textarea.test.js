...
describe("Textarea component tests", () => {
  ...
  test("Disabled textarea renders with correct aria and can not be modified", async () => {
    const onChange = jest.fn();
    const { getByLabelText, user } = setup(<DxcTextarea label="Example label" onChange={onChange} disabled />);
    const textarea = getByLabelText("Example label");
