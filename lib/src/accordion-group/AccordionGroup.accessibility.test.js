  ...
  it("Should not have basic accessibility issues", async () => {
    const { container } = render(
      <DxcAccordionGroup defaultIndexActive={1}>
        <DxcAccordionGroup.Accordion label="Accordion1" assistiveText="Assistive Text1" icon={folderIcon} margin="small" defaultIsExpanded>
          <div>First accordion</div>
        </DxcAccordionGroup.Accordion>
        <DxcAccordionGroup.Accordion label="Accordion2" assistiveText="Assistive Text2" icon={folderIcon} margin="small" defaultIsExpanded>
