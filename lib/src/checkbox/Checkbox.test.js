...
describe("Checkbox component tests", () => {
  ...
  test("Test keyboard interactions", () => {
    const onChange = jest.fn();
    const { getByRole, getByTestId } = render(<DxcCheckbox label="Checkbox" name="test" onChange={onChange} />);

    const checkbox = getByRole("checkbox");

    userEvent.tab();
    expect(document.activeElement === getByTestId("checkbox-main-container")).toBeTruthy();
