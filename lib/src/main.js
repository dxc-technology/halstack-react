...
import DxcPassword from "./password/Password";
import DxcNewDate from "./new-date/NewDate";
import DxcNumber from "./number/Number";
import DxcNewTextarea from "./new-textarea/NewTextarea";
import DxcNewSelect from "./new-select/NewSelect";
