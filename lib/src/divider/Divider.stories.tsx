...
export const Chromatic = () => (
  <>
    ...
    <Title title="Default 30%" level={4} />
    <ExampleContainer>
      <DxcFlex gap="1rem" direction="column">
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
    ...
    <Title title="Default 50%" level={4} />
    <ExampleContainer>
      <DxcFlex gap="1rem" direction="column">
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
    ...
    <Title title="Default 80%" level={4} />
    <ExampleContainer>
      <DxcFlex gap="1rem" direction="column">
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
    ...
    <Title title="Default Full-Width" level={4} />
    <ExampleContainer>
      <DxcFlex gap="1rem" direction="column">
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
    ...
    <Title title="Vertical 30%" level={4} />
    <ExampleContainer>
      <DxcFlex gap="1rem" direction="row">
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
        ...
        <FixedHeightDiv>
          <DxcDivider orientation="vertical" width="30%" />
        </FixedHeightDiv>
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
          arcu purus. Sodales elementum sollicitudin consequat elementum tortor. Lectus eget cursus ut ac pharetra
    ...
    <Title title="Vertical 50%" level={4} />
    <ExampleContainer>
      <DxcFlex gap="1rem" direction="row">
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
        ...
        <FixedHeightDiv>
          <DxcDivider orientation="vertical" width="50%" />
        </FixedHeightDiv>
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
          arcu purus. Sodales elementum sollicitudin consequat elementum tortor. Lectus eget cursus ut ac pharetra
    ...
    <Title title="Vertical 80%" level={4} />
    <ExampleContainer>
      <DxcFlex gap="1rem" direction="row">
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
        ...
        <FixedHeightDiv>
          <DxcDivider orientation="vertical" width="80%" />
        </FixedHeightDiv>
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
          arcu purus. Sodales elementum sollicitudin consequat elementum tortor. Lectus eget cursus ut ac pharetra
    ...
    <Title title="Vertical Full-Width" level={4} />
    <ExampleContainer>
      <DxcFlex gap="1rem" direction="row">
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
        ...
        <FixedHeightDiv>
          <DxcDivider orientation="vertical" width="Full-Width" />
        </FixedHeightDiv>
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
          arcu purus. Sodales elementum sollicitudin consequat elementum tortor. Lectus eget cursus ut ac pharetra
    ...
    <ExampleContainer>
      <DxcFlex gap="1rem" direction="row">
        ...
        <DxcDivider orientation="vertical" color="dark-grey" />
        <DxcParagraph>
          Lorem ipsum dolor sit amet consectetur. Tincidunt sed pharetra mollis duis volutpat urna. Hendrerit aliquet et
          arcu purus. Sodales elementum sollicitudin consequat elementum tortor. Lectus eget cursus ut ac pharetra
          lobortis integer eu. Potenti amet ac id risus ac nunc orci nibh. Tempus vitae vitae aenean arcu. Nibh
