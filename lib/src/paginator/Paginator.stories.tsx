...
export const Chromatic = () => (
  <>
    ...
    <ExampleContainer>
      <Title
        title="Default with items per page options"
        theme="light"
        level={4}
      />
    ...
    <ExampleContainer>
      <Title
        title="Default with show go to page selector"
        theme="light"
        level={4}
      />
    ...
    <ExampleContainer>
      <Title
        title="Page change and items per page options"
        theme="light"
        level={4}
      />
      <DxcPaginator
    ...
    <ExampleContainer>
      <Title
        title="Page change and show go to page selector"
        theme="light"
        level={4}
      />
      <DxcPaginator
    ...
    <ExampleContainer>
      <Title
        title="Page change, show go to page and items per page selectors"
        theme="light"
        level={4}
      />
      <DxcPaginator
