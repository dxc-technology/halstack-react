...
describe("NewInputText component tests", () => {
  ...
  test("Input Strict - Length constraint", () => {
    ...
    expect(
      getByText("Please lengthen this text to 5 characters or more (you are currently using 4 characters).")
    ).toBeTruthy();
    fireEvent.blur(input);
    expect(
      getByText("Please lengthen this text to 5 characters or more (you are currently using 4 characters).")
    ...
    userEvent.type(input, "test ");
    expect(queryByText(/Please lengthen this text to/)).toBeFalsy();
  });
  ...
  test("Input Non Strict - Length constraint", () => {
    const onChange = jest.fn((value, error) => {
      expect(value).toBe("t");
      expect(error).toBe("Please lengthen this text to 5 characters or more (you are currently using 1 characters).");
    });
  ...
  test("onChange function is called correctly", () => {
    ...
    expect(onChange).toHaveBeenCalledWith("onchange event test", undefined);
  });
  ...
  test("onBlur function is called correctly", () => {
    ...
    expect(onBlur).toHaveBeenCalledWith("Test string");
  });
  ...
  test("Uncontrolled input", () => {
    ...
    expect(onChange).toHaveBeenCalled();
    expect(onChange).toHaveBeenCalledWith("Uncontrolled test", undefined);
...
//   test("Asynchronous autosuggest request failed", async () => {
